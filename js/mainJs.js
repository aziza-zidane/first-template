...
allTABS.forEach(element => {
 ...
 //responsive
const myForm = document.querySelector("header form");
const headerText = document.querySelector(".text-header");


// myForm.style.height = (window.innerHeight - headerText.offsetHeight - 64) + "px"
